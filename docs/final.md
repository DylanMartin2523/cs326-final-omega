...
## Conclusion
Working in our group for this project was a fun and new experience. We were able to hop in voice calls and talk through each of the problems that we were running into. There were many new things to learn throughout this project and including creating a full webpage and deploying it to Heroku as well as using bootstrap to help beautify the website. There were a few difficulties that we encountered when using Heroku when trying to deploy the application such as having difficulties connecting GitHub as well as using mongoDB for our backend. There was also some trouble surrounding the Accounts at first as they aren’t as straight forward to setup as we originally thought they would be. Some of the things that we would’ve liked to know before starting this project are: how to use a database like mongoDB before we needed to use it in our application as well as what the final form of the website was expected to look like from the beginning so that we could make sure that it fits what was needed. The project as a whole was very interesting and a lot of fun since we got to work in a group with a good dynamic and helped us learn a lot.
